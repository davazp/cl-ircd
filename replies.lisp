...
(defmacro defreply (code name &optional string abort)
    ...
    `(defun ,name (&key ,@variables)
       ...
       (rpl ,(format nil "~3,'0d" code)
            ,@(mapcar (lambda (format-argument)
                      ...
                      format-arguments))
       ,(when abort `(abort-command)))))

(defmacro deferr (code name &optional string)
  `(defreply ,code ,name ,string t))
...
(deferr 401 ERR-NOSUCHNICK "<nickname> :No such nick/channel")
(deferr 402 ERR-NOSUCHSERVER "<server name> :No such server")
(deferr 403 ERR-NOSUCHCHANNEL "<channel name> :No such channel")
(deferr 404 ERR-CANNOTSENDTOCHAN "<channel name> :Cannot send to channel")
(deferr 405 ERR-TOOMANYCHANNELS "<channel name> :You have joined too many channels")
(deferr 406 ERR-WASNOSUCHNICK "<nickname> :There was no such nickname")
(deferr 407 ERR-TOOMANYTARGETS "<target> :<error code> recipients. <abort message>")
(deferr 408 ERR-NOSUCHSERVICE "<service name> :No such service")
(deferr 409 ERR-NOORIGIN ":No origin specified")
(deferr 411 ERR-NORECIPIENT ":No recipient given (<command>)")
(deferr 412 ERR-NOTEXTTOSEND ":No text to send")
(deferr 413 ERR-NOTOPLEVEL "<mask> :No toplevel domain specified")
(deferr 414 ERR-WILDTOPLEVEL "<mask> :Wildcard in toplevel domain")
(deferr 415 ERR-BADMASK "<mask> :Bad Server/host mask")
(deferr 421 ERR-UNKNOWNCOMMAND "<command> :Unknown command")
(deferr 422 ERR-NOMOTD ":MOTD File is missing")
(deferr 423 ERR-NOADMININFO "<server> :No administrative info available")
(deferr 424 ERR-FILEERROR ":File error doing <file op> on <file>")
(deferr 431 ERR-NONICKNAMEGIVEN ":No nickname given")
(deferr 432 ERR-ERRONEUSNICKNAME "<nick> :Erroneous nickname")
(deferr 433 ERR-NICKNAMEINUSE "<nick> :Nickname is already in use")
(deferr 436 ERR-NICKCOLLISION "<nick> :Nickname collision KILL from <user>@<host>")
(deferr 437 ERR-UNAVAILRESOURCE "<nick/channel> :Nick/channel is temporarily unavailable")
(deferr 441 ERR-USERNOTINCHANNEL "<nick> <channel> :They aren't on that channel")
(deferr 442 ERR-NOTONCHANNEL "<channel> :You're not on that channel")
(deferr 443 ERR-USERONCHANNEL "<user> <channel> :is already on channel")
(deferr 444 ERR-NOLOGIN "<user> :User not logged in")
(deferr 445 ERR-SUMMONDISABLED ":SUMMON has been disabled")
(deferr 446 ERR-USERSDISABLED ":USERS has been disabled")
(deferr 451 ERR-NOTREGISTERED ":You have not registered")
(deferr 461 ERR-NEEDMOREPARAMS "<command> :Not enough parameters")
(deferr 462 ERR-ALREADYREGISTRED ":Unauthorized command (already registered)")
(deferr 463 ERR-NOPERMFORHOST ":Your host isn't among the privileged")
(deferr 464 ERR-PASSWDMISMATCH ":Password incorrect")
(deferr 465 ERR-YOUREBANNEDCREEP ":You are banned from this server")
(deferr 466 ERR-YOUWILLBEBANNED)
(deferr 467 ERR-KEYSET "<channel> :Channel key already set")
(deferr 471 ERR-CHANNELISFULL "<channel> :Cannot join channel (+l)")
(deferr 472 ERR-UNKNOWNMODE "<char> :is unknown mode char to me for <channel>")
(deferr 473 ERR-INVITEONLYCHAN "<channel> :Cannot join channel (+i)")
(deferr 474 ERR-BANNEDFROMCHAN "<channel> :Cannot join channel (+b)")
(deferr 475 ERR-BADCHANNELKEY "<channel> :Cannot join channel (+k)")
(deferr 476 ERR-BADCHANMASK "<channel> :Bad Channel Mask")
(deferr 477 ERR-NOCHANMODES "<channel> :Channel doesn't support modes")
(deferr 478 ERR-BANLISTFULL "<channel> <char> :Channel list is full")
(deferr 481 ERR-NOPRIVILEGES ":Permission Denied- You're not an IRC operator")
(deferr 482 ERR-CHANOPRIVSNEEDED "<channel> :You're not channel operator")
(deferr 483 ERR-CANTKILLSERVER ":You can't kill a server!")
(deferr 484 ERR-RESTRICTED ":Your connection is restricted!")
(deferr 485 ERR-UNIQOPPRIVSNEEDED ":You're not the original channel operator")
(deferr 491 ERR-NOOPERHOST ":No O-lines for your host")
(deferr 501 ERR-UMODEUNKNOWNFLAG ":Unknown MODE flag")
